...
try
{
	...
	$telemetryKey ="27404a3f-0913-48bf-908d-77c93f0ea8b4"
	...
	$onlinePolicyStoreUrl = "https://getazsdkcontrolsms.azurewebsites.net/api/files?version=`$Version&fileName=`$FileName"

    #This is the org-neutral CDN endpoint. This gets overridden in org-policy setup.
	$CoreSetupSrcUrl = "https://azsdkossep.azureedge.net/1.0.0/RunbookCoreSetup.ps1"
